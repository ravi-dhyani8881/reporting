...
public class PushNotificationManager {
	 ...
	 * @throws NullIdException
	 */
	public void removeAllDevices() throws UnknownDeviceException, NullIdException{
		//logger.debug( "Removing All Token from Device" );
		DeviceFactory.getInstance().removeAllDevice();
	}
